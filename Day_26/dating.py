...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 10 16:43:27 2019

@author: narayan
"""

"""
Code Challenge (Connecting Hearts)
...
Iyengar for their paper Gender Differences in Mate Selection: Evidence from a Speed Dating Experiment.
...
participant of the opposite sex. At the end of their four minutes, participants were asked 
if they would like to see their date again.
...
For example: being funny is more important for women than man in selecting a partner! 
Being sincere on the other hand is more important to men than women.
    ...
    How important do people think attractiveness is in potential mate selectdatingion vs. its real impact?
"""
