...
dataset = pd.read_csv('material/bluegills.csv')
...
print ("Predicting result with Linear Regression :"+str(lin_reg.predict(np.array(5).reshape(1,-1))))


print ("Predicting result with Polynomial Regression :"+str(lin_reg_2.predict(poly_reg.fit_transform(np.array(5).reshape(1,-1)))))